module.exports = {
        ...
        files:[
            {
                src:  [
                    ...
                    'angular-promise-buttons/dist/angular-promise-buttons.js',
                    'ng-youtube-embed/src/ng-youtube-embed.js',
                    'angular-loading-bar/build/**',
                    'angular-auto-complete/angular-auto-complete.js',
                    'angular-auto-complete/angular-auto-complete.css',
                    'lodash/dist/lodash.min.js',
                    'angular-confirm/dist/**'
                ],
                dest: 'libs/angular',
    ...
    //apache: {
    //    files: [
    //        {expand: true, src: ['**'], cwd: 'src/',   dest: "/var/www/html/neosuniversity/"},
    //         {expand: true, src: ['**'], cwd: 'libs/',   dest: "/var/www/html/libs/"}
    //    ]
   // },
