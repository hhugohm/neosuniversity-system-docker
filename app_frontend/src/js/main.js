...
angular.module('app')
  .controller('AppCtrl', ['$scope', '$translate', '$localStorage', '$window', 'jwtHelper','store',
    function(              $scope,   $translate,   $localStorage,   $window ,  jwtHelper,  store) {
      ...
      $scope.getName = function(){
       return $scope.userLogged.name;
      }

      $scope.getRol= function() {
          return $scope.userLogged.rol;
      }
