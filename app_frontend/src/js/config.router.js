...
angular.module('app')
  .run(
    [          '$rootScope', '$state', '$stateParams', 'jwtHelper','store','$location',
      function ($rootScope,   $state,   $stateParams,   jwtHelper,  store,  $location) {
          ...
          $rootScope.$on("$stateChangeStart", function (event, toState, toParams, fromState, fromParams) {
            ...
            if (token===null && !toState.url.includes("/success-signup") &&
                !toState.url.includes("/signup") && !toState.url.includes("/success-resetpwd") &&
                !toState.url.includes("/resetpwd/:email/:hash") ) {
      ...
      //        .otherwise('/app/dashboard-v1');
       //   }
          ...
          $stateProvider
              ...
              .state('app.cursoGitAlumno', {
                url: '/curso-git-alumno',
                templateUrl: 'tpl/neosuniversity/curso-git.alumno.html',
                resolve: load(['js/controllers/neosuniv/curso-git.alumno.js'])
            })
              .state('app.dashboard-v1', {
                  url: '/dashboard-v1',
                  templateUrl: 'tpl/app_dashboard_v1.html?prd=123'

              }).state('app.playlesson', {
                  url: '/playlesson/:controlPanelId/:classId/:sectionId/:description',
                  templateUrl: 'tpl/course/playlesson.html?cmd=prd1',
                  resolve: load(['js/controllers/neosuniv/playlessonController.js'])
              }).state('app.playlesson-premier', {
                  url: '/playlessonPremier/:courseId/:classId/:sectionId/:description/:id',
                  templateUrl: 'tpl/neosuniversity/playlesson-premier.html?cmd=prd1'
              }).state('app.courses', {
                url: '/courses',
                templateUrl: 'tpl/neosuniversity/career.html?prd=2'
            }).state('app.course-overview', {
                url: '/course-overview/:courseId/:description',
                templateUrl: 'tpl/neosuniversity/course-overview.html?cmd=prd7',
                resolve: load(['toaster','smart-table','textAngular'])
            }).state('app.successpago', {
              url: '/paysuccess',
              params: {
                  data: null
              },
              templateUrl: 'tpl/neosuniversity/admin/successPago.html'
          }).state('app.inscripcion', {
                url: '/inscripcion/:courseId/:isfree',
                templateUrl: 'tpl/neosuniversity/inscripcion.html'
            }).state('app.newcourse', {
                  url: '/newcourse',
                  templateUrl: 'tpl/neosuniversity/admin/newcourse.html',
                  resolve: load(['toaster','smart-table','textAngular'])
              }).state('app.alumnosadm', {
                  url: '/alumnosadm',
                  templateUrl: 'tpl/neosuniversity/admin/alumnosadm.html',
                  resolve: load(['moment','toaster','smart-table','textAngular'])
              }).state('app.cursopremier', {
                  url: '/premiercourse/:courseId/:id',
                  templateUrl: 'tpl/neosuniversity/curso-premier.html?prd=2',
                  resolve: load(['moment','toaster','smart-table','textAngular'])
              })
              .state('app.adminsections', {
                  url: '/adminsections/:courseId/:courseName',
                  templateUrl: 'tpl/neosuniversity/admin/adminsections.html',
                  resolve: load(['toaster','smart-table','textAngular'])
              })
              ...
              .state('access.signin', {
                  url: '/signin',
                  templateUrl: 'tpl/neosuniversity/page_signin.html?cmd=test',
                  resolve: load( ['js/controllers/signin.js'] )
              })
              .state('access.signup', {
                  url: '/signup',
                  templateUrl: 'tpl/neosuniversity/page_signup.html',
                  resolve: load( ['js/controllers/signup.js'] )
              })
              .state('access.success-signup', {
                  url: '/success-signup',
                  templateUrl: 'tpl/neosuniversity/success-signup.html'
              })
              .state('access.reset-pwd', {
                  url: '/success-resetpwd',
                  templateUrl: 'tpl/neosuniversity/security/reset_pwd.html'
              })
              .state('access.resetpwdEmail', {
                  url: '/resetpwd/:email/:hash',
                  templateUrl: 'tpl/neosuniversity/security/reset_pwd.mail.html',
                  resolve: load(['toaster', 'js/controllers/toaster.js'])
              })
