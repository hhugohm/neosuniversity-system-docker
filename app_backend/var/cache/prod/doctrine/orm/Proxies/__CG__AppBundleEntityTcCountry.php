 ...
 */
class TcCountry extends \AppBundle\Entity\TcCountry implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\TcCountry' . "\0" . 'idcountry', '' . "\0" . 'AppBundle\\Entity\\TcCountry' . "\0" . 'countryname'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TcCountry $proxy) {
