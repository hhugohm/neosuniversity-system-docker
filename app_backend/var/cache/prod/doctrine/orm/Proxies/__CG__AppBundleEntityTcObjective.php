 ...
 */
class TcObjective extends \AppBundle\Entity\TcObjective implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\TcObjective' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\TcObjective' . "\0" . 'objectiveName'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TcObjective $proxy) {
